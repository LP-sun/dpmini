...
# 测试 batch_size=32
/home/ubuntu/miniforge3/envs/ai4m/bin/python train_cuda.py \
...
### Step 2: 中期测试（需要修改代码）
1. 修改 `train_cuda.py` 支持 `--batch-size` 参数覆盖
...
python -m torch.utils.bottleneck train_cuda.py ...
```
